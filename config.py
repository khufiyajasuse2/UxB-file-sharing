...
#Your db channel Id
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1002019112712"))
...
#Database 
DB_URI = os.environ.get("DATABASE_URL", "mongodb+srv://sumairakhan122112:fqkbPZBYIADqX1fk@terabox.cv45syt.mongodb.net/?retryWrites=true&w=majority&appName=terabox")
DB_NAME = os.environ.get("DATABASE_NAME", "terabox1")
